...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> register(User user) {
        ...
        return ServerResponse.createBySuccessMessage("注册成垢");
    }
    ...
    public ServerResponse<String> forgetResetPassword(String username, String newPassword, String forgetToken) {
        ...
        if (StringUtils.equals(forgetToken, token)) {
            ...
            if (rowCount > 0) {
                return ServerResponse.createBySuccessMessage("修改密码成垢");
            }
        } else {
    ...
    public ServerResponse<String> resetPassword(String oldPassword, String newPassword, User user) {
        int relustCount = userMapper.checkPassword(MD5Util.MD5EncodeUtf8(oldPassword), user.getId());
        if (relustCount == 0) {
            return ServerResponse.createByErrorMessage("密码错误");
        }
        ...
        if (updateCount > 0) {
            return ServerResponse.createBySuccessMessage("密码更新成垢");
        }
    ...
    public ServerResponse<User> getInformation(Integer uerId) {
        User user = userMapper.selectByPrimaryKey(uerId);
        if (user == null) {
